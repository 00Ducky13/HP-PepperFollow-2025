...
class WaypointNavigator:
    ...
    def __init__(self, waypoints):
        ...
        self.max_linear_speed = 0.4      # Speed on straights (m/s)
        ...
        self.linear_noise = 0.05           # Max linear wiggle (+/- m/s)
...
if __name__ == '__main__':
    try:
        ...
        path_s_maze_loop = [
            ...
            (4.0, 1.0),  # Go left
            (-3.0, 1.0), # Go to bottom-left corner
            (-3.0, -4.0),  # Go up to middle-left
        ...
        #rospy.sleep(5)
        navigator = WaypointNavigator(path_s_maze_loop)
        # -----------------------------
